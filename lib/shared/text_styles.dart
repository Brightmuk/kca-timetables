...
TextStyle minorTextStyle = TextStyle(color: Colors.grey,fontSize: 13.sp);
TextStyle majorTextStyle = TextStyle(fontSize: 30.sp,fontWeight: FontWeight.w300);
TextStyle titleTextStyle = TextStyle(fontSize: 14.sp,fontWeight: FontWeight.w500,color: primaryThemeColor);
